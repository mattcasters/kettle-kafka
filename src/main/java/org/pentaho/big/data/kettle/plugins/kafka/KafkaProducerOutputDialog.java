...
public class KafkaProducerOutputDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  private void buildSetupTab() {
    ...
    fdlClientId.top = new FormAttachment( wBootstrapServers, Const.MARGIN );
    ...
    fdClientId.top = new FormAttachment( wlClientId, Const.MARGIN );
    ...
    wTopic.getCComboWidget().addListener(
      SWT.FocusIn,
      event -> {
        KafkaDialogHelper kafkaDialogHelper = new KafkaDialogHelper(wTopic, wBootstrapServers, kafkaFactory, optionsTable, meta.getParentStepMeta() );
