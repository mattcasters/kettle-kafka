...
import org.apache.kettle.plugins.kafka.widget.VFSFileSelection;
...
public abstract class BaseStreamingDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  public String open() {
    ...
    fdlTransPath.top = new FormAttachment( spacer, 3*Const.MARGIN );
    ...
    fdCreateSubtrans.right = new FormAttachment( 100, 0 );
    fdCreateSubtrans.top = new FormAttachment( wlTransPath, 3*Const.MARGIN );
    ...
    fdFileSelection.right = new FormAttachment( wbCreateSubtrans, -Const.MARGIN );
    fdFileSelection.top = new FormAttachment( wbCreateSubtrans, 0, SWT.CENTER );
